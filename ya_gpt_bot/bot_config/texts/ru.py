...
**/reset_preferences** - сбросить значения параметров в значения по умолчанию
...
**/digest** - краткий пересказ последних событий чата

**/tg_id** - получить значение своего или чужого (по реплаю) идентификатора Telegram
